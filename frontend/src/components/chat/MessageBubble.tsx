...
export default function MessageBubble({
  message, currentUserId, onDelete, onReply,
}: MessageBubbleProps) {
    ...
    >
      ...
      <div style={{ maxWidth: "65%", position: "relative" }}>
        ...
        <div style={{
          ...
          {message.replyTo && (
            <div style={{
              background: isMine ? "rgba(0,0,0,0.2)" : "rgba(255,255,255,0.08)",
              borderLeft: "3px solid",
              borderColor: isMine ? "rgba(255,255,255,0.5)" : "#7c3aed",
              borderRadius: "8px",
              padding: "6px 10px",
              marginBottom: "8px",
              fontSize: "12px",
              ...
              <div style={{
                color: isMine ? "rgba(255,255,255,0.7)" : "#a78bfa",
              ...
              <div style={{ color: isMine ? "rgba(255,255,255,0.6)" : "#9ca3af" }}>
                {message.replyTo.type === "image" ? "📸 Image" : message.replyTo.content.slice(0, 60)}
              </div>
            </div>
          )}
